...
void main() {
	...
	float noiseBand = smoothstep(0.04, 0.0, abs(sampleUv.y - noiseCenter)) * step(0.38, random(vec2(noiseCycle, 12.0)));
	...
	float bandGrain = (random(sampleUv * uResolution.xy + floor(uTime * 48.0)) - 0.5) * noiseBand * 0.18;
